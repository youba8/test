              ...
              <tr>
                ...
                <table cellspacing="1" class="carttable">
                 ...
                 <c:if test="${cart!=null }">
				   ...
				   <div style="text-align:right; margin-top:10px"><a href="#"><img src="images/gwc_jx.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/dispacher.do?type=order"><img src="images/gwc_buy.gif" border="0" /></a></div>
